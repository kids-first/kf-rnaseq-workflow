...
arguments:
  ...
  - position: 20
    shellQuote: false
    valueFrom: >-
      && /usr/local/STAR-Fusion/ctat-genome-lib-builder/prep_genome_lib.pl --pfam_db Pfam-A.hmm --human_gencode_filter
  - position: 30
    shellQuote: false
    valueFrom: >-
...
inputs:
  ...
  genome_fa: { type: File, inputBinding: { position: 22, prefix: "--genome_fa" }, doc: "GENCODE primary assembly reference fasta file. MUST BE UNZIPPED" }
  reference_gtf: { type: 'File', inputBinding: { position: 22, prefix: "--gtf" }, doc: "gene model definitions. MUST BE UNZIPPED" }
