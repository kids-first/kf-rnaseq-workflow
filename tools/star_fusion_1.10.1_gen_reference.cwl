...
requirements:
  ...
  - class: ResourceRequirement
    ...
    ramMin: ${ return inputs.cores * 4000 }
...
arguments:
  - position: 2
    ...
    valueFrom: >-
      ...
      --fusion_annot_lib $(inputs.ctat_source.dirname)/$(inputs.ctat_source.nameroot.replace(".tar", ""))/$(inputs.fusion_annot_lib)
      ${
          var arg = "--dfam_db ";
...
inputs:
  ...
  fusion_annot_lib: { type: string, doc: "fusion annot lib file name in ctat source. Usually fusion_lib.{embedded data in ctat file name}.dat.gz" }
