...
id: star-2.7.10a-alignReads-custom
label: "STAR Aligner v2.7.10a Custom"
requirements:
  - class: ShellCommandRequirement
  - class: DockerRequirement
    dockerPull: 'pgc-images.sbgenomics.com/brownm28/star:2.7.10a_alpha_220601'
...
arguments:
  ...
  - position: 2
    ...
    valueFrom: >-
      ...
      --readFilesCommand $(inputs.reads_records.some(function(e) { return e.reads1.nameext == '.gz' }) ? 'pigz -dc' : 'cat')
