...
doc: |-
  ...
  Kids First favors setting/overriding defaults with "arriba-heavy" specified in [STAR docs](docs/STAR_2.7.10a.md)
  ```yaml
...
inputs:
  ...
  gtf_anno: {type: 'File', doc: "General transfer format (gtf) file with gene models\
      \ corresponding to fasta reference"}
  ...
  outFilterMismatchNoverLmax: {type: 'float?', default: 0.1, doc: "alignment will\
      \ be output only if its ratio of mismatches to *mapped* length is less than\
  ...
  outFilterType: {type: ['null', {type: enum, name: outFilterType, symbols: ["BySJout",
      ...
      \ filtering using only current alignment. BySJout (default): keep only those\
  ...
  outReadsUnmapped: {type: ['null', {type: enum, name: outReadsUnmapped, symbols: [
      ...
      \ mapped (i.e. mapped only one mate of a paired end read) reads in separate\
      \ file(s). none (default): no output. Fastx: output in separate fasta/fastq\
      \ files, Unmapped.out.mate1/2."}
  ...
  outSAMstrandField: {type: ['null', {type: enum, name: outSAMstrandField, symbols: [
      ...
      \ field flag. None: not used. intronMotif (default): strand derived from the\
      \ intron motif. This option changes the output alignments: reads with inconsistent\
  ...
  alignSoftClipAtReferenceEnds: {type: ['null', {type: enum, name: alignSoftClipAtReferenceEnds,
      ...
      \ the alignments past the end of the chromosomes. Yes (default): allow. No:\
  ...
  outSAMunmapped: {type: ['null', {type: enum, name: outSAMunmapped, symbols: ["Within",
      ...
      \ unmapped mate for each alignment, and, in case of unsorted output, keep it\
      \ adjacent to its mapped mate. Only affects multi-mapping reads"}
  ...
  alignSJstitchMismatchNmax: {type: 'string?', default: "0 -1 0 0", doc: "maximum\
      \ number of mismatches for stitching of the splice junctions. Value '5 -1 5\
      \ 5' improves SF chimeric junctions, also recommended by arriba (AR)"}
  alignSplicedMateMapLmin: {type: 'int?', default: 0, doc: "minimum mapped length\
      \ for a read mate that is spliced. SF recommends 30"}
  alignSplicedMateMapLminOverLmate: {type: 'float?', default: 0.66, doc: "alignSplicedMateMapLmin\
      \ normalized to mate length. SF recommends 0, AR 0.5"}
  chimJunctionOverhangMin: {type: 'int?', default: 15, doc: "minimum overhang for\
      \ a chimeric junction. SF recommends 8, AR 10"}
  chimMultimapNmax: {type: 'int?', default: 0, doc: "maximum number of chimeric multi-alignments.\
      \ SF recommends 20, AR 50."}
  chimMultimapScoreRange: {type: 'int?', default: 1, doc: "the score range for multi-mapping\
      \ chimeras below the best chimeric score. Only works with chimMultimapNmax >\
      \ 1. SF recommends 3"}
  chimNonchimScoreDropMin: {type: 'int?', default: 20, doc: "int>=0: to trigger chimeric\
      \ detection, the drop in the best non-chimeric alignment score with respect\
      \ to the read length has to be greater than this value. SF recommends 10"}
  ...
  chimOutType: {type: ['null', {type: enum, name: chimOutType, symbols: ["Junctions\
            ...
            \ WithinBAM HardClip"]}], default: "Junctions SeparateSAMold WithinBAM\
      \ SoftClip", doc: "type of chimeric output. Args are additive, and defined as\
      \ such - Junctions: Chimeric.out.junction. SeparateSAMold: output old SAM into\
      \ separate Chimeric.out.sam file WithinBAM: output into main aligned BAM files\
      \ (Aligned.*.bam). WithinBAM HardClip: hard-clipping in the CIGAR for supplemental\
      \ chimeric alignments WithinBAM SoftClip:soft-clipping in the CIGAR for supplemental\
      \ chimeric alignments"}
  chimScoreDropMax: {type: 'int?', default: 20, doc: "max drop (difference) of chimeric\
  ...
  chimScoreSeparation: {type: 'int?', default: 10, doc: "int>=0: minimum difference\
      \ (separation) between the best chimeric score and the next one. AR recommends\
      \ 1"}
  chimSegmentMin: {type: 'int?', default: 12, doc: "minimum length of chimeric segment\
      \ length, if ==0, no chimeric output. REQUIRED for SF, 12 is their default,\
      \ AR recommends 10"}
  chimSegmentReadGapMax: {type: 'int?', default: 0, doc: "maximum gap in the read\
      \ sequence between chimeric segments. AR recommends 3"}
  outFilterMultimapNmax: {type: 'int?', default: 20, doc: "max number of multiple\
  ...
  peOverlapNbasesMin: {type: 'int?', default: 0, doc: "minimum number of overlap bases\
      \ to trigger mates merging and realignment. Specify >0 value to switch on the\
      \ 'merging of overlapping mates'algorithm. SF recommends 12,  AR recommends\
      \ 10"}
  ...
  estimate_rspd: {type: 'boolean?', doc: "Set this option if you want to estimate\
      \ the read start position distribution (RSPD) from data", default: false}
  # annoFuse
  sample_name: {type: 'string', doc: "Sample ID of the input reads"}
  annofuse_col_num: {type: 'int?', doc: "column number in file of fusion name."}
  # rmats
