...
outputs:
  ...
  RMASeQC_Metrics: {type: File, outputSource: rna_seqc/Metrics)
  RMASeQC_Gene_TPM: {type: File, outputSource: rna_seqc/Gene_TPM)
  RMASeQC_Gene_count: {type: File, outputSource: rna_seqc/Gene_count)
  RMASeQC_Exon_count: {type: File, outputSource: rna_seqc/Exon_count)
