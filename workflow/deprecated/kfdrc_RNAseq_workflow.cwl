...
doc: >-
  ...
  [STAR v2.6.1d](https://doi.org/f4h523) is used to align RNA-seq reads.
  ...
  1. `wf_strand_param` is a workflow convenience param so that, if you input the following, the equivalent will propagate
  ...
  1. Suggested `STAR_outSAMattrRGline`, with **TABS SEPARATING THE TAGS**,  format is:
